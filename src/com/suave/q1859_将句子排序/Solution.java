...
public class Solution {
    public String sortSentence(String s) {
        return Arrays.stream(s.split(" ")).sorted((o1, o2) -> {
            ...
            return c1 - c2;
        }).map(o -> o.substring(0, o.length() - 1)).collect(Collectors.joining(" "));
    }

    public static void main(String[] args) {
        System.out.println(new Solution().sortSentence("is2 a3 sentence4 This1"));
    }
}
