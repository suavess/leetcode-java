package com.suave.q2460_对数组执行操作;
...
public class Solution {
    public int[] applyOperations(int[] nums) {
        ...
        if (nums[length - 1] != 0) {
            res[index] = nums[length - 1];
        }
        return res;
    }

    public static void main(String[] args) {
        new Solution().applyOperations(new int[]{847,847,0,0,0,399,416,416,879,879,206,206,206,272});
    }
}
